...
public class M2_cafe_creme {
    public static void main(String[] args) {
        ...
        int nombre1Cent = clavier.nextInt();

        System.out.print("pièces de 5 cents ? ");
        int nombre5Cents = clavier.nextInt();

        System.out.print("pièces de 10 cents ? ");
        int nombre10Cents = clavier.nextInt();

        System.out.print("pièces de 20 cents ? ");
        int nombre20Cents = clavier.nextInt();

        System.out.print("pièces de 50 cents ? ");
        int nombre50Cents = clavier.nextInt();

        int total = nombre1Cent * 1 + nombre5Cents * 5 + nombre10Cents * 10 + nombre20Cents * 20 + nombre50Cents * 50;
